...
void print_help(){
    printf("Usage:\n");
    printf("cup <total vertices> [verbose]\n");
    exit(0);
}
            ...
            for( int X1 = 0 ; X1 <= X/2 ; X1++ ){
                ...
                for( int X11 = 0 ; X11 <= X1/2 ; X11++ ){
                    for( int X21 = 0 ; X21 <= X2/2 ; X21++ ){
                        ...
                        if( X21 == 0 ) graph_connect_vertices( &g , 2 , 3 );
                        else {
                        ...
                        if( X22 == 0 ) graph_connect_vertices( &g , 2 , 3 );
                        else {
                            graph_connect_vertices( &g , 2 , open_index );
                        ...
                        if( Y1 == 0 ) graph_connect_vertices( &g , 0 , 2 );
                        else {
                            graph_connect_vertices( &g , 0 , open_index );
                            for( int i = 1 ; i < Y1 ; i++ , open_index++ ){
                                graph_connect_vertices( &g , open_index , open_index+1 );
                            }
                            graph_connect_vertices(&g , open_index++ , 2 );
                        }

                        if( Y2 == 0 ) graph_connect_vertices( &g , 1 , 3 );
                        else {
                            graph_connect_vertices( &g , 1 , open_index );
                            for( int i = 1 ; i < Y2 ; i++ , open_index++ ){
                                graph_connect_vertices( &g , open_index , open_index+1 );
                            }
                            graph_connect_vertices(&g , open_index++ , 3 );
                        }
                        ...
                        if( min_W == Wg ){
                            ...
                            *min_data = empty_vector;
                            vector_push_back_int( min_data , Y1 );
                            vector_push_back_int( min_data , Y2 );
